...
The exact machine-readable database bundled in Nomva 1.6 (build 46) and the 1.7 (build 47) TestFlight candidate is available as a [compressed SQLite download](https://github.com/jerrycrews1/Nomva/releases/download/food-db-9debd65e/foods.sqlite.gz). Its uncompressed SHA-256 is `9debd65ed41eadf15f9d1d01346e5b5115d3d8525f5d08cbdf6a6f38696be9df`. The GitHub release carries the same license and attribution notice. Future database revisions must publish their exact database artifact and notice before the corresponding app build is distributed.
